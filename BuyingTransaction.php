					...
					<ul class="list-group mt-1">
						...
						<li style="" class="list-group-item">
							...
							<div class="btn-group btn-group-sm">
								  ...
								  <span onclick="load('BuyingTransaction')" type="button" id="payoff" class="btn btn-success"><i class="fa fa-refresh"></i></span>	
								  
							</div>
							
							<span class="f-bold t-u ft-12">Crypto <span class="color-g">Buyers</span></span>
