		...
		<div class="row">			
			...
			<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
				...
				<ul class="list-group mt-2">
					...
					<center><img src="img/icon/buy-btc.png" class="avatar"/></center>
					</li>
				...
				<form class="pb-1" id="buybtcnow" autocomplete="off">
						<div class="text-right mt-1 mb-2">
						 <button class="btn btn-default"><i class="fa fa-shopping-cart"></i>&nbsp; Buy BTC</button>
						</div>
				<p class="textStyler">Deduct  From : </p>
